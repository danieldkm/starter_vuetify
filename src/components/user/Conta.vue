...
export default {
    data: () => ({
        ...
        senha: '',
        senhaRules: [
            v => !!v || 'Senha atual não foi informado',
        ],
        novaSenha: '',
        novaSenhaRules: [
        ...
        onSubmit(event) {
            ...
            try {
                if(this.validate()) {
                    ...
                    if(this.senha && this.novaSenha && this.confirmarNovaSenha) {
                        let tmpUser = {
                        ...
                        this.$store.dispatch("updateUsuarioAndChangePassword", tmpUser);
                    } else {
                        this.$store.dispatch("updateUsuario", this.usuario);
                    }
                } else {
                    this.$store.dispatch("updateMessage", {
                        error: true, message: 'Há campos inválidos, por favor verifique novamente.'
                    });
